...
<body class="auth-page">
    ...
    <div class="auth-wrapper">
        <div class="auth-image-side" style="background-image: url('asset/bglogin.png');">
            </div>
        <div class="auth-form-side">
            <div class="auth-box new-auth-box">
                <a href="index.html"><img src="asset/logo.png" alt="Reymoto Logo" class="logo"></a>
                <h2>Reserve motor parts with ease</h2>
                <p class="subtitle">Login to ReyMotoParts and secure what you need</p>
                <form id="login-form">
